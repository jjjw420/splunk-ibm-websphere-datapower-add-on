...
def do_run():
    ...
    wsm_msg_payloads_folder = config.get("wsm_msg_payloads_folder", "/opt/splunk/esb/dpwsm")
    wsm_msg_payloads_use_mongodb = int(config.get("wsm_msg_payloads_use_mongodb",0))
    wsm_msg_payloads_mongodb_db_name = config.get("wsm_msg_payloads_mongodb_db_name", "dpwsm")
    wsm_msg_payloads_mongodb_host = config.get("wsm_msg_payloads_mongodb_host", "127.0.0.1")
    wsm_msg_payloads_mongodb_port = int(config.get("wsm_msg_payloads_mongodb_port", 27018))
